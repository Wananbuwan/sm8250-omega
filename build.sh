#!/bin/bash
KERNEL_DIR="/home/infected_/kernel_oneplus_sm8250"
KBUILD_OUTPUT="/home/infected_/kernel_oneplus_sm8250/out"
ZIP_DIR="/mnt/Building/AnyKernel3-omega"
export USE_CCACHE=1
make clean && make mrproper
rm -rf out
time make O=$KBUILD_OUTPUT CC=clang omega_defconfig
...
time make -j$(nproc --all) O=out CC=clang CLANG_TRIPLE=aarch64-linux-gnu- CROSS_COMPILE=/mnt/Building/gcc-10.x-aarch64-linux-gnu-master/bin/aarch64-linux-gnu-
